        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-12">
            <div className="text-center">
              ...
              <h3 className="mt-6 text-xl font-semibold text-gray-800">Data-Driven Insights</h3>
              <p className="mt-4 text-gray-600">Make informed decisions with our advanced analytics platform.</p>
            </div>
            <div className="text-center">
              <Users className="mx-auto h-12 w-12 text-blue-600" />
              <h3 className="mt-6 text-xl font-semibold text-gray-800">Team Collaboration</h3>
              <p className="mt-4 text-gray-600">Foster seamless communication and productivity across teams.</p>
            </div>
            <div className="text-center">
              <Globe2 className="mx-auto h-12 w-12 text-blue-600" />
              <h3 className="mt-6 text-xl font-semibold text-gray-800">Global Reach</h3>
              <p className="mt-4 text-gray-600">Connect with customers and partners worldwide.</p>
            </div>
          </div>
        </div>
      </section>
